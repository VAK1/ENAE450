...
class DemoPublisher(Node):
    ...
    def __init__(self):
        ...
        self.pose_subscription = self.create_subscription(Pose, 'turtlesim1/turtle1/pose', self.set_pose, 10)
        self.goal_subscription = self.create_subscription(TurtleArray, 'alive_turtles', self.set_goal, 10)
