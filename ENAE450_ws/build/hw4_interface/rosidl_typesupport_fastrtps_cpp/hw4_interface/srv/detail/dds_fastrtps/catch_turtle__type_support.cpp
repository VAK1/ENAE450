...
#include "hw4_interface/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hw4_interface::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hw4_interface::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hw4_interface::srv::CatchTurtle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hw4_interface::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hw4_interface::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hw4_interface, srv, CatchTurtle_Request)() {
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hw4_interface
cdr_serialize(
  const hw4_interface::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hw4_interface::srv::CatchTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hw4_interface::srv::CatchTurtle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hw4_interface::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hw4_interface::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hw4_interface, srv, CatchTurtle_Response)() {
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hw4_interface, srv, CatchTurtle)() {
  return &hw4_interface::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
