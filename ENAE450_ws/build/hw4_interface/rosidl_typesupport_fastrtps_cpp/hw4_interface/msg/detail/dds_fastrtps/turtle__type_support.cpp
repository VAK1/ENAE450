...
#include "hw4_interface/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hw4_interface::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hw4_interface::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hw4_interface::msg::Turtle;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const hw4_interface::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hw4_interface::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &hw4_interface::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hw4_interface, msg, Turtle)() {
  return &hw4_interface::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
