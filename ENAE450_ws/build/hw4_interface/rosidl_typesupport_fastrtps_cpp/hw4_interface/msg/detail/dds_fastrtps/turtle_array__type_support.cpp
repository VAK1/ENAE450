...
#include "hw4_interface/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const hw4_interface::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  hw4_interface::msg::Turtle &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: array
  {
    ...
    for (size_t i = 0; i < size; i++) {
      hw4_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.array[i],
        cdr);
    }
  }
  ...
  hw4_interface::msg::TurtleArray & ros_message)
{
  // Member: array
  {
    ...
    for (size_t i = 0; i < size; i++) {
      hw4_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        hw4_interface::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        hw4_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = hw4_interface::msg::TurtleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hw4_interface::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hw4_interface::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &hw4_interface::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
