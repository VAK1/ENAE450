...
class GraphDrawer:
    def __init__(self):
        ...
        self.teleport_client = self.node.create_client(TeleportAbsolute, 'turtle1/teleport_absolute')
        self.set_pen_client = self.node.create_client(SetPen, 'turtle1/set_pen')
